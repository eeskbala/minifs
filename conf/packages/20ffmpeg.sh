...
hset gst-plugins-bad depends "gstreamer gst-plugins-base gst-plugins-good"
...
hset gst-plugins-ugly depends "gstreamer gst-plugins-base gst-plugins-bad libx264"
